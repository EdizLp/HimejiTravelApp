...
from src.utils import check_master_records, add_to_records, combine_two_dictionaries
...
def main():
    ...
    with open('./tests/test4.html', 'r', encoding='utf-8') as f:                                                                                    #Opening our test file using encoding for japanese characters
        tabelogData = f.read()
